...
<Note>
  This is for React Router v7 Implementations. For Next.js Shopify, an additional documentation page will be created.
</Note>
...
This will help you get started with local fonts only for now. For google fonts follow this. 
